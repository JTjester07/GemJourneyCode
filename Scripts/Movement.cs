...
public class Movement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (cooldownTimer <= 0f)
        {
            ...
            if (currentTile != null)
            {
                if (!(horizontalInput != 0 && verticalInput != 0) && !(question.gameObject.activeSelf))
    ...
    private void MovePlayer(Vector2 movement)
    {
        ...
        if (currentTileTwo != null)
        {
            ...
            if (currentTileTwo.name == "tile_2" || currentTileTwo.name == "tile_0" || currentTileTwo.name == "tile_3")
            {
